...
var r = (a, e, t) => (f(a, typeof e != "symbol" ? e + "" : e, t), t);
...
class P {
  ...
  on(e, t) {
    this.controlPanelDispatcher.on(e, t), this.controlPanelDispatcher.emit({
      type: "dispatch",
      origin: "control-panel",
      name: e,
      transactionId: h()
...
class M {
  constructor() {
    ...
    const e = new p(), t = new u();
    this.api = new D(t), this.events = new P({ controlPanelDispatcher: e }), this.persistentStorage = new w(e, t);
  }
}
